...
#ifndef scintUserEventInformation_h
#define scintUserEventInformation_h 1

class scintUserEventInformation : public G4VUserEventInformation
{
public:
  scintUserEventInformation();
  ~scintUserEventInformation();
