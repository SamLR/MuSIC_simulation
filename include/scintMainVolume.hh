...
// ********************************************************************
//
#ifndef scintMainVolume_H
#define scintMainVolume_H 1
...
class scintMainVolume : public G4PVPlacement
{
public:
  scintMainVolume(G4RotationMatrix *pRot,
...
private:
  ...
  void PlacePMTs(G4LogicalVolume* pmt_Log,
		 ...
		 G4double &x, G4double &y, G4double &z, G4int &k,scintPMTSD* sd);
  ...
  //Sensitive Detectors
  static scintScintSD* scint_SD;
  static scintPMTSD* pmt_SD;
};
