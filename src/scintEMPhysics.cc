...
scintEMPhysics::scintEMPhysics(const G4String& name)
               :  G4VPhysicsConstructor(name)
{
}

scintEMPhysics::~scintEMPhysics()
{
}
...
void scintEMPhysics::ConstructParticle()
{
  // gamma
...
void scintEMPhysics::ConstructProcess()
{
