...
// ********************************************************************
//
#include "scintWLSFiber.hh"
#include "globals.hh"
#include "G4LogicalSkinSurface.hh"
#include "G4LogicalBorderSurface.hh"

G4LogicalVolume* scintWLSFiber::clad2_log=NULL;

scintWLSFiber::scintWLSFiber(G4RotationMatrix *pRot,
		 ...
		 "Cladding2",pMotherLogical,pMany,pCopyNo),constructor(c)
{
  ...
  if(!clad2_log || updated){
    ...
    G4LogicalVolume* Fiber_log = 
      new G4LogicalVolume(Fiber_tube,G4Material::GetMaterial("Vacuum"),
			  "Fiber",0,0,0);
    ...
    G4LogicalVolume* clad1_log = 
      new G4LogicalVolume(clad1_tube,G4Material::GetMaterial("Vacuum"),
			  "Cladding1",0,0,0);
    ...
    clad2_log = 
      new G4LogicalVolume(clad2_tube,G4Material::GetMaterial("Vacuum"),
			  "Cladding2",0,0,0);
